                            ...
                            <div class="single-features-area">
                                ...
                                <div class="feature-content d-flex align-items-center justify-content-between" style="padding: 60px 20px 20px 20px">
                                    ...
                                    <div class="feature-favourite">
                                        <a href="/wanbo/package/{{ $package->id }}" role="button" class="popover-test" title="more detail" data-content="{{ $package->computer_spec }}"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
